...
plt.plot(x_dense, spline_fixed(x_dense), '-', color='blue', linewidth=2, label='Original protocol')
plt.plot(x_dense, spline_dyn(x_dense), '-', color='red', linewidth=2, label='Optimized protocol')
